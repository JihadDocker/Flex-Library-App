   ...
   <!-- @JihadDocker : Fixed navbar :  -->
    ...
    <div class="container">
        <div class="col-sm-12 page-header" align="left">
          <h2 class="demo-headline" style="color:#365896">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Borrow &nbsp;Book</h2>
        </div>
    </div>
       ...
       <!-- @JihadDocker : page body :  -->
          <form class="form-horizontal" action="borrow.php" method="get">          
            <div class="form-group">
              <label class="col-sm-2 lead" align='right'> &nbsp;</label>
              <div class="col-sm-5" align='left'>
                 ...
                 ?>
                <!-- @JihadDocker : <input type="text" class="form-control" name="bid" placeholder="Input book ID here"></input> :  -->
              </div>  
              <div class="col-sm-3" align='left'>
                <button type="submit" class="btn btn-inverse" name="check" value="submit">Check  &nbsp;</button>
              </div>
            </div>
            <div class="form-group" >
              <label class="col-sm-2 lead" align='right'> &nbsp;</label>
              <div class="col-sm-5" align='left'>
                 <?php
                    ...
                    else {echo "<input type='text' class='form-control' name='bname' placeholder='Please click the [Check  &nbsp;] bottom '/>";}
                 ?>
              </div>
            </div> 
            <div class="form-group" >
           ...
           <!-- @JihadDocker : <div class="form-group">       :  -->
         ...
         <!-- @JihadDocker : <form class="form-horizontal" id='9'> :  -->
