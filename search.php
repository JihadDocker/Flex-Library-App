<html lang="en">
  <head>
   ...
   <!-- @JihadDocker : <link href="css/switch.css" rel="stylesheet"> :  -->
               ...
               <div class="form-group"> 
                  <div class="row">
                    ...
                    <div class="col-md-2 column">
                     ...
                     <!-- @JihadDocker : <div class="col-md-2 column"><br /></div> :  -->
