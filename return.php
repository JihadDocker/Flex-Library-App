   ...
   <!-- @JihadDocker : Fixed navbar :  -->
    ...
    <div class="container">
        <div class="col-sm-12 page-header" align="left">
          <h2 class="demo-headline" style="color:#365896">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Search &nbsp;Record</h2>
        </div>
    </div>
    <div class="container">
      <form method="get" action="return.php">
          <div class="panel panel-default">
            <div class="panel-body">
                <label class="col-md-4 lead" align='center'>Please Input the  &nbsp;</label>
                <div class="col-sm-5 form-group">
                  <div class="input-group">
                    <input class="form-control" name="cid" type="search" placeholder=" &nbsp; Here...">
      ...
      <?php
          if (isset($_GET["submit"]))
          {
            ...
            if($arr)
            {
              ...
              echo'<div class="panel-heading" align="center">Borrow Record &nbsp; &nbsp;&nbsp; &nbsp; '.$cid.'</div>';
