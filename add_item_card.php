<html lang="en">
  <head>
    ...
    <meta name="description" content="Flex Flex Library Application">
  ...
  <body>  
   <!-- @JihadDocker : Fixed navbar :  -->
    ...
    </div>       <!-- @JihadDocker : accessing database :  -->
    <div class="container">
        <?php
          if(isset($_POST['submit']))
          {
             ...
             if (mysqli_affected_rows($con)==1) echo "<script>alert('Add card succeed!');window.location='add_item_card.php'</script>";
             else echo "<script>alert('Add card failed! Please check your input.');window.location='add_item_card.php';</script>";
          }
        ?>

       <!-- @JihadDocker : page body :  -->
        
        <form class="form-horizontal" action="add_item_card.php" method="POST">
         ...
         <!-- @JihadDocker : <input type="text" class="form-control" id="exampleInputPassword1" name="user_id" placeholder="">             :  -->
