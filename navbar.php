<div class="navbar navbar-inverse " role="navigation">
  <div class="container">
    <div class="navbar-header">
      ...
      <a class="active navbar-brand" href="main.php">Flex Library Application</a>
    </div>
    <div class="collapse navbar-collapse">
      <ul class="nav navbar-nav">
       <!-- @JihadDocker : <li class="active"><a href="index.php">Home</a></li> :  -->
        ...
        <li class="dropdown">
         <!-- @JihadDocker : <li><a href="#about">Card</a></li> :  -->
          <a href="#" class="dropdown-toggle" data-toggle="dropdown">Card<b class="caret"></b></a>
          <ul class="dropdown-menu">
            <li><a href="add_item_card.php">Add Card</a></li>
      ...
      <p class="nav navbar-text navbar-right">
        <?php 
           session_start();
          if(isset($_SESSION["aid"])) echo '';
          if(isset($_SESSION["aid"])) echo '<a href="logout.php"> Log Out</a>';
